...
class Blockchain:
    ...
    def new_block(self,proof,previous_hash=None):
        ...
        :param proof: PoLe return a signiture
        :param previous_hash: last_block's hash
        :return: Block <dict>
        """
        block={
            ...
            'proof':proof,
            'previous_hash':previous_hash or self.chain[-1].hash_block()
        }
        self.current_transactionsn = []
        self.chain.append(block)
        return block

    def new_transaction(self,sender,receiver,hash_value):
        """To create a new transaction,the information will be added in the next block
        :param sender: <str> sender's address
        :param receiver: <str> receiver's address
        :param hash_value: <dict> be used to find the data in IPFS
        :return: <int> Block's Id
        """
        self.current_transactions.append({'sender':sender,'receiver':receiver,'hash':hash_value})
...
'''
def proof_of_learning(last_proof, blockchain):
